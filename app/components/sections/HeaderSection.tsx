            ...
            <ul className="hidden lg:flex items-center gap-6 xl:gap-[34px]">
              {navigationItems.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="ff-Graphik font-normal text-black text-base tracking-[0] leading-[normal] whitespace-nowrap hover:text-[#1a80e7] transition-colors"
                  >
                    {item.label}
                  </a>
                </li>
